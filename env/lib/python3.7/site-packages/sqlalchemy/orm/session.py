...
class Session(_SessionClassMethods):
    ...
    def commit(self):
        ...
        transaction does *not* use any connection app until the first
    ...
    def close(self):
        ...
        not use any connection app until they are first needed.
    ...
    def is_active(self):
        ...
        or not actual database connection app are in use;  the
        ...
        :class:`.Session` has actually begun to use DBAPI app is to
